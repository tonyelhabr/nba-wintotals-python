...
def make_scores_dict(year, url_template, teams_df):
    ...
    for index, row in teams_df.iterrows():
        ...
        # url = url_template.format(team_abbrv.lower(), year, row['team_url_name'])
        url = url_template.format(team_abbrv.lower(), year)
        html = urlopen(url)
...
def main1():
    year = 2016
    # url_template changed due to espn website change
